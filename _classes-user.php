...
{ 
 ...
 {      
  ...
  $mail->Port       = 465;              
  $mail->AddAddress("thisForAdminEmail@hotmail.com"); //admin
  $mail->Username="thisIsYOuEmail@gmail.com";  
  $mail->Password="yourpassword";            
  $mail->SetFrom('thisIsYOuEmail@gmail.com','Admin Assignment-2');
  $mail->AddReplyTo("thisIsYOuEmail@gmail.com","Admin test");
 ...
 {      
  ...
  $mail->Host       = "smtp.gmail.com";      
  $mail->Port       = 465;   
  $mail->AddAddress($email);  //users
  $mail->Username="thisIsYOuEmail@gmail.com";  
  $mail->Password="yourpassword";              
  $mail->SetFrom('thisIsYOuEmail@gmail.com','User Assignment-2');
  $mail->AddReplyTo("thisIsYOuEmail@gmail.com","Assignment2 test");
  $mail->Subject    = $subject;
  $mail->MsgHTML($message);
  $mail->Send();
 } 
